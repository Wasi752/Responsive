...
function Home (){
    return(
        <div className="w-full h-full">
            <div className="w-full h-20 md:h-36 lg:h-1/6 lg:ml-20 bg-green-200">
                        ...
                        <div className="w-full h-20 md:h-36 lg:h-1/6 flex">
                                ...
                                <div className="w-8/12 h-full md:w-9/12 md:h-2/6 flex justify-left ">
                                    <img src="palo-bangla.svg" className="w-[60%] h-[60%] md:w-[23%] md:h-[23%] md:mt-5"/>
                                </div>

                                <div class="w-2/12 h-full md:w-[12%] md:h-full flex flex-row-reverse mt-5">
                                    <div class="w-[50%] h-[50%] md:w-[60%] md:h-[90%] md:mt-1 md:ml-8 md:mr-20 "><p className="border text-xl text-center p-1 hidden md:block">Login</p><img src="images.jpeg" className="w-full h-full block md:hidden"/></div>
                                    <div class="w-[15%] h-full"><img src="01notifacatioicon.jpeg" className="hidden md:block h-[30%] w-full mt-1"/></div>
                                </div>
                        </div>
